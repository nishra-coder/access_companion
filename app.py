...
# --- DESCRIPTION BLOCK (Paste this right here) ---
st.markdown("""
...
# Display Chat History with the new layout
...
# Generate Response (Fixed Thread Context Handling)
if st.session_state.messages and st.session_state.messages[-1]["role"] == "user":
    with st.spinner("Thinking..."):
        start_time = time.time()
        
        # 1. Reconstruct full chat history for the Agent
        history = []
        ...
        # 2. Pass the full history to keep implicit context
